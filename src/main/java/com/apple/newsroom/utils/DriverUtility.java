package com.apple.newsroom.utils;
...
/**
 * @description: Page Object class for DriverUtility
...
public class DriverUtility {
	...
	public static void loadPropertyFile() {
		...
		try {
			prop.load(new FileInputStream("C:\\workspaces\\AppleProduct\\config\\configuration.properties"));
